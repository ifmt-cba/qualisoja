...
def testar_crud_completo():
    ...
    try:
        ...
        print(f"   ✅ Urase FP criada: ID {urase_fp.id} - Resultado: {urase_fp.resultado}")
        ...
        print(f"   ✅ Cinza SA criada: ID {cinza_sa.id} - Resultado: {cinza_sa.resultado}%")
        ...
        print(f"   ✅ Teor de Óleo FP criado: ID {teor_fp.id} - Resultado: {teor_fp.teor_oleo}%")
        ...
        print(f"   ✅ Fibra SA criada: ID {fibra_sa.id} - Resultado: {fibra_sa.resultado}%")
        ...
        print(f"   ✅ Fósforo FP criado: ID {fosforo_fp.id} - Resultado: {fosforo_fp.get_resultado_formatado()} ppm")
        ...
        print(f"   📊 Análises de Teor de Óleo: {AnaliseTeorOleo.objects.count()}")
